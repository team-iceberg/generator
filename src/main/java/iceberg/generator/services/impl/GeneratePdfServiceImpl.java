...
public class GeneratePdfServiceImpl implements GeneratePdfService {
    ...
    public File createFile(Family family) {
        File file;
        try {
            String fileName = family.getName() + " - GROUPE " + family.getGroup() + "_";
    ...
    private void generatePdf(FileOutputStream fos, Family family) throws IOException, DocumentException, URISyntaxException {
    ...
    private PdfPCell getTitle(Family family) {
        ...
        String familyName = "Famille : " + getLastname(family.getName());
        String guardian = "\nResponsable légal :";
